...
$configs= array(
		...
		'MODULE_ALLOW_LIST'  => array('Admin','Portal','Shop','Asset','Api','User','Wx','Comment','Qiushi','Tpl','Topic','Install','Bug','Better','Pay'),
		...
		'URL_ROUTE_RULES'		=>array(
								'slist$'		=> 'shop/list/index?id=0',
								'activity'		=> 'portal/list/index?id=1',
								'article/:id\d$' => 'portal/article/:id',
								'good/:id\d$' => 'Shop/article/:id',
								'slist/:id\d$' => 'Shop/list/:id',
								
								'meal' => 'shop/meal/index',
								
								/*转到404*/
								'shop/list/index/:id' => 'shop/empty/index',
								'shop/article/index/:id' => 'shop/empty/index',
								'portal/list/index/:id' => 'shop/empty/index',
								'portal/article/index/:id' => 'shop/empty/index',
								),
		/*url路由*/
